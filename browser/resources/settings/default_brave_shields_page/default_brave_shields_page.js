...
console.log('===============')
console.log('default_brave_shields_page.js')
...
Polymer({
  ...
  properties: {
    ...
    httpsEverywhereControlType_: String,
    noScriptControlType_: String,
  },
  ...
  ready: function() {
    console.log('===============')
    console.log('default_brave_shields_page.js::: ready')
    ...
    this.browserProxy_.getHTTPSEverywhereControlType().then(value => {
      this.httpsEverywhereControlType_ = value;
    });
    this.browserProxy_.getNoScriptControlType().then(value => {
      this.noScriptControlType_ = value;
    });
  },
  ...
  onHTTPSEverywhereControlChange_: function() {
    this.browserProxy_.setHTTPSEverywhereControlType(this.$.httpsEverywhereControlType.value);
  },
  onNoScriptControlChange_: function() {
    this.browserProxy_.setNoScriptControlType(this.$.noScriptControlType.value);
  },
});
})();
